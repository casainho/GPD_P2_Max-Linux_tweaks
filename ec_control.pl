...
my $TEMPERATURE_FAN_DISABLE = 50;
my $TEMPERATURE_FAN_LEVEL_1 = 55;
my $TEMPERATURE_FAN_LEVEL_2 = 60;
my $TEMPERATURE_FAN_LEVEL_3 = 65;
my $TEMPERATURE_FAN_LEVEL_4 = 70;
